...
\begin{homeworkProblem}[Task 1 Database Design]
	...
	\end{homeworkSection}
				...
				\includegraphics[scale=0.5 ]{Task1/ERxcf.png}
		\end{homeworkSection}
...
Please see the file named: RobertRigler\_220CT\_Task3.pdf\\

The References for this task are located on the last page of this document.
\end{homeworkProblem}
...
\begin{homeworkProblem}[Bibliography]
	\begin{homeworkSection}{References for Task 3: A Poster of Ethics}
		\begin{enumerate}
			\item \url{http://www.data-archive.ac.uk/create-manage/consent-ethics} \hfill
			\item \url{http://www.ukdataservice.ac.uk/manage-data/legal-ethical/obligations.aspx}
			\item \url{http://www.england.nhs.uk/wp-content/uploads/2013/06/dpa-policy-1.pdf}
		\end{enumerate}
	\end{homeworkSection}
