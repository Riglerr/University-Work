...
\begin{homeworkProblem}[Task 4 : Amazon recommendation system]
	...
	\begin{homeworkSection}{What is a Recommendation System?}
		...
		Recommendation systems are commonly described as:\\\\  "\textit{A way of presenting information on items and products that are likely to be of interest to the reader.}" $[1]$\\
		 ...
		 \Large{MOAR OF THIS, EXPANDED EXAMPLES E-COMMERCE, BOOK RECOMMENDATIONS, ETC}
	\end{homeworkSection}
	...
	\begin{homeworkSection}{Benefits and limitations of a Recommendation system}
			...
			\begin{description}
				...
				This data can help drive the direction of the business to improve future sales and sales forcasting.
				\pagebreak
	...
	\begin{homeworkSection}{Analysis techniques}
		...
		And if \textit{User B} also postivively rates \textit{Product 1} and \textit{2} and also positively rates \textit{Product 3}, then the system will determine that \textit{User A} would also like \textit{Product 3} and recommend it to them.\\
	...
	\begin{description}
		...
		\item[Transparency]\hfill \\
			The system must be 'transparent' i.e it doesn't impede or get in the way of the custome making purchases. It must gather information without having to explicitly ask for it, so it runs parallel to the shopping process.
		\item [Speed]\hfill \\
...
\begin{homeworkProblem}[Bibliography]
	...
	\begin{homeworkSection}{References for Task 4: A Recommendation system}
		...
		\begin{enumerate}
			...
			\item \url{http://webcache.googleusercontent.com/search?q=cache:X2_XVw9qTIcJ:readwrite.com/2009/01/28/5_problems_of_recommender_systems+&cd=1&hl=en&ct=clnk&gl=uk}
			\item \url{https://www.few.vu.nl/nl/Images/werkstuk-hiralall_tcm38-202691.pdf}
