...
\begin{homeworkProblem}[Task 1 Database Design]
	...
	\begin{homeworkSection}{Activity 1: First Normal Form}{
		...
		\hspace{3.5cm} \emph{ItemOrder} entity\\
		 \includegraphics[scale = 0.3]{Task1/Item1NF.png}
		 \vfill
		 
		 
		 \includegraphics[scale =0.6]{Task1/Order1NF.png}
	...
	\begin{homeworkSection}{Activity 2: Second Normal Form}
		...
		\subsubsection{Entities in Second Normal Form}
	...
	\begin{homeworkSection}{Activity 3: Third Normal Form}
		...
		\pagebreak
			\subsubsection{Entities in Third Normal Form}
