...
\chead{\hmwkClass\ : \hmwkClassShort} % Top center head
...
%\Cscript{Assignment_1/Ass2}{Log file}
}
...
\homeworkSection{2.  Show a table of the interuppts on the system}
\problemAnswer{
\begin{center}
...
\homeworkSection{1. Complete the cr\textunderscore read\textunderscore byte}
See Code below
\homeworkSection{2.Prove the file is being buffered}
see code below
\homeworkSection{3. Provide some statistics}
To count the number of bytes read, I created a variable called \emph{byte\textunderscore tot} in the \emph{cr\textunderscore file} structure in the cache\textunderscore reader.h file. This variable is used in the \emph{Refill()} method, it adds the value of the \emph{len} variable to itself.
See code below.
\Cscript{Assignment_5/item1}{Commented Buffer Code}
\Cscript{Assignment_6/cache_example}{Adapted code}
\clearpage
