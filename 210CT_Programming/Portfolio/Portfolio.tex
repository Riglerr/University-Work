...
\Procedure{BOOL LINEARSEARCH}{$item$, $list$[\hspace{1mm}]}\\
 ...
 \indent \If{ $list[i] = list$} t \hspace{12.75mm}(n) 

 \indent \indent \indent \Return true \hspace{17.4mm} (n) 
\EndIf
\EndFor

 \indent \Return false\hspace{32.5mm} (1) 
\EndProcedure
\end{algorithmic}
\end{algorithm}
...
\indent \indent \indent \Return true \hspace{36.5mm}(n*n)
\EndIf
\EndFor
\EndFor

\Return false \hspace{53mm}(1)
\EndProcedure
\end{algorithmic}
\end{algorithm}
